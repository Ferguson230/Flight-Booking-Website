	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST') {
		...
		if (empty($errors)) { 
			...
			if ($num > 0) {
				...
				header("Location: http://lyndoncis.com/CIS3120SP16/tdl01030/Project/welcomepage.php");
				echo 'Success! Redirecting...';																
				exit(); 
				
			} else { // If it did not run OK.
				// Public message:
				header ("refresh:5; url = http://lyndoncis.com/CIS3120SP16/tdl01030/Project/account.php"); 
